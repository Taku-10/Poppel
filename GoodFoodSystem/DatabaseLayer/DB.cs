...
namespace GoodFoodSystem.DatabaseLayer
{
    public class DB
    {
        ...
        private string tempstrconn = ConfigurationManager.ConnectionStrings["Poppel"].ConnectionString;
        private string strConn = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Takunda\\Downloads\\Takudaiso\\Takufambawo\\haya\\GoodFoodSystem\\PoppelOrderProcessing.mdf;Integrated Security=True";
      //  private string strConn = ConfigurationManager.ConnectionStrings["Poppel"].ConnectionString;

        protected SqlConnection cnMain;
        protected SqlConnection tempConn;
        protected DataSet dsMain;
        protected SqlDataAdapter daMain;
        protected SqlCommand cmdMain;
        
        
       
        
        private string adminQuery = "Select * From Admin Where";
        private string signUpQuery = "insert into [Admin] ([username], [password]) values (@usn, @pwd)";
        ...
        public SqlConnection TempConn { get => tempConn; set => tempConn = value; }
        public SqlConnection CnMain { get => cnMain; set => cnMain = value; }
      
       
       
        
    
        public string AdminQuery { get => adminQuery; set => adminQuery = value; }
        public string SignUpQuery { get => signUpQuery; set => signUpQuery = value; }
        ...
        public DB()
        {
            try
            {
               ...
               tempConn = new SqlConnection(tempstrconn);
                dsMain = new DataSet();
            }
        ...
        public void FillDataSet(string aSQLstring, string aTable)
        {
            try
            {
                ...
                daMain.Fill(dsMain, aTable);//Adds or refreshes rows in the DataSet to match those in the data source. https://docs.microsoft.com/en-us/dotnet/api/system.data.common.dataadapter.fill?view=net-5.0
                                            ...
                                            //Fill takes as its arguments a DataSet to be populated, and a DataTable object, or the ProductName of the DataTable to be filled with the rows returned from the SelectCommand. https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/populating-a-dataset-from-a-dataadapter
        ...
        { //The method has two parameters SQL statement to be used to do the update and the table which needs to be updated.
            ...
            try
            {
                ...
                /*
                 ...
                 an instance of a DataSet, and an optional DataTable object or DataTable ProductName.
                ...
                FillDataSet(sqlLocal, table); //refresh the dataset using the SQL statement; and the Table from which the insertquery will emanate from
                #endregion
